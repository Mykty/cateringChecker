...
public class DinnerFragment extends Fragment {
    ...
    int volunteerC = 0;
    int dinnerCount = 0;
    ArrayList<Personnel> dinnertList;
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot daysSnap : dataSnapshot.getChildren()) {
                    for (DataSnapshot foodTime : daysSnap.getChildren()) {
                        ...
                        if (daysSnap.getKey().equals("dinner")) {
    ...
    public void addPersonnelToList(String id_number, String time) {
        ...
        if (res != null && (res.getCount() > 0)) {
            ...
            dinnertList.add(personnel);
            eatersAdapter.notifyDataSetChanged();
        }
    }

    public void updateViews() {
        System.out.println("updateViews Dinner");
        personnelMenu.setCount(dinnerCount + " / " + tarbiewiListCount());
    ...
    public void setupViews() {
        ...
        dinnertList = new ArrayList<>();
        eatersAdapter = new EatersListAdapter(getActivity(), dinnertList);
    ...
    public void checkInList(String id_number) {
        ...
        for (Personnel personnel : dinnertList) {
